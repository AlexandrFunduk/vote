...
public class UserTestData {
    ...
    public static final User user1 = new User(USER_ID+1, "User1", "user1@yandex.ru", "123456", Role.USER);
    public static final User user2 = new User(USER_ID+2, "User2", "user2@yandex.ru", "654321", Role.USER);
