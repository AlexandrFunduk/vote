package ru.alexandrfunduk.vote.web.user;
...
import ru.alexandrfunduk.vote.service.UserService;
...
import static ru.alexandrfunduk.vote.TestUtil.readFromJson;
...
import static ru.alexandrfunduk.vote.web.ExceptionInfoHandler.EXCEPTION_DUPLICATE_EMAIL;
import static ru.alexandrfunduk.vote.web.user.ProfileRestController.REST_URL;
...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void update() throws Exception {
        ...
        USER_MATCHER.assertMatch(userService.get(USER_ID), UserUtil.updateFromTo(new User(user1), updatedTo));
    }
