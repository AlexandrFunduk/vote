...
public class MenuTestData {
    ...
    public static final MenuTo menuTo2 = new MenuTo(MENU_ID + 1, LocalDate.of(2020, 12, 1), RestaurantTestData.restaurant2.getId(), Map.of("pizza", 27000, "pasta", 25000, "coffee", 11000));
